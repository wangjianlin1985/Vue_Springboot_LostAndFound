<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="标签代码" prop="biaoqiandaima">
          <el-input v-model="ruleForm.biaoqiandaima" 
              placeholder="标签代码" clearable  :readonly="ro.biaoqiandaima"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="标签代码" prop="biaoqiandaima">
              <el-input v-model="ruleForm.biaoqiandaima" 
                placeholder="标签代码" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.wupinfenlei = true;
          ...
          if(o=='biaoqiandaima'){
            this.ruleForm.biaoqiandaima = obj[o];
	    this.ro.biaoqiandaima = true;
            continue;
          }
        }
      }
