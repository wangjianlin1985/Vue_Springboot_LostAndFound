<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="寻物编号" prop="xunwubianhao">
          <el-input v-model="ruleForm.xunwubianhao" 
              placeholder="寻物编号" clearable  :readonly="ro.xunwubianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="寻物编号" prop="xunwubianhao">
              <el-input v-model="ruleForm.xunwubianhao" 
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="举报日期" prop="jubaoriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.jubaoriqi" 
                type="date"
                :readonly="ro.jubaoriqi"
                placeholder="举报日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jubaoriqi" label="举报日期" prop="jubaoriqi">
              <el-input v-model="ruleForm.jubaoriqi" 
                placeholder="举报日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  created() {
	this.ruleForm.jubaoriqi = this.getCurDate()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='xunwubianhao'){
            this.ruleForm.xunwubianhao = obj[o];
	    this.ro.xunwubianhao = true;
            continue;
          }
          if(o=='wupinmingcheng'){
	    ...
	    this.ro.jubaoyuanyin = true;
          ...
          if(o=='jubaoriqi'){
            this.ruleForm.jubaoriqi = obj[o];
	    this.ro.jubaoriqi = true;
            continue;
          }
          if(o=='xuehao'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `xunwujubao/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.xunwujubaoCrossAddOrUpdateFlag = false;
						 this.parent.search();
