  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='baoguanyuan'" class="input-group">
			   <div class="label">发布学号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.fabuxuehao" class="input" type="text" placeholder="发布学号">
			   </div>
			 </div> -->
			<el-form-item label="发布学号" class="input" v-if="tableName=='baoguanyuan'">
			  <el-input v-model="ruleForm.fabuxuehao" autocomplete="off" placeholder="发布学号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='baoguanyuan'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='baoguanyuan'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<el-form-item label="确认密码" class="input" v-if="tableName=='baoguanyuan'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>
			...
			<el-form-item label="发布姓名" class="input" v-if="tableName=='baoguanyuan'">
			...
			<el-form-item label="身份证" class="input" v-if="tableName=='baoguanyuan'">
			  <el-input v-model="ruleForm.shenfenzheng" autocomplete="off" placeholder="身份证"  />
			</el-form-item>
			<!-- <div v-if="tableName=='baoguanyuan'" class="input-group">
			   <div class="label">邮箱</div>
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='baoguanyuan'">
			  <el-input v-model="ruleForm.youxiang" autocomplete="off" placeholder="邮箱"  />
			</el-form-item>
			<!-- <div v-if="tableName=='baoguanyuan'" class="input-group">
			...
			<el-form-item label="联系手机" class="input" v-if="tableName=='baoguanyuan'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((!this.ruleForm.fabuxuehao) && `baoguanyuan` == this.tableName){
        this.$message.error(`发布学号不能为空`);
        return
      }
      if((!this.ruleForm.mima) && `baoguanyuan` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
      if((this.ruleForm.mima!=this.ruleForm.mima2) && `baoguanyuan` == this.tableName){
	    this.$message.error(`两次密码输入不一致`);
	    return
      }
      if((!this.ruleForm.fabuxingming) && `baoguanyuan` == this.tableName){
        this.$message.error(`发布姓名不能为空`);
        return
      }
      if(`baoguanyuan` == this.tableName && this.ruleForm.shenfenzheng&&(!this.$validate.checkIdCard(this.ruleForm.shenfenzheng))){
        this.$message.error(`身份证应输入身份证格式`);
        return
      }
      if(`baoguanyuan` == this.tableName && this.ruleForm.youxiang&&(!this.$validate.isEmail(this.ruleForm.youxiang))){
        this.$message.error(`邮箱应输入邮件格式`);
        return
      }
      if(`baoguanyuan` == this.tableName && this.ruleForm.lianxishouji&&(!this.$validate.isMobile(this.ruleForm.lianxishouji))){
